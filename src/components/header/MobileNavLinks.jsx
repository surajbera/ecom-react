...
const MobileNavLinks = () => {
  ...
  return (
    <div className='flex gap-4 items-center relative float-right lg:hidden'>
      ...
      {showMenu && (
        <ul className='flex-col border-2 border-transparent border-solid dark:border-slate-500 font-medium rounded-lg overflow-hidden absolute top-[2.3rem] right-0 w-[150px] z-10'>
